 ...
 * Use the {@link SobreAppFragment#newInstance} factory method to
...
public class SobreAppFragment extends Fragment {
     ...
     * @return A new instance of fragment SobreAppFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SobreAppFragment newInstance(String param1, String param2) {
        SobreAppFragment fragment = new SobreAppFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sobre_app, container,
                false);
        getActivity().setTitle(R.string.sobreapp);
        return rootView;
